...
public class Logs {
    ...
    public Logs() {
        ...
        Bukkit.getConsoleSender().sendMessage("§c§l[§3TntRun§c§l] §aEnabling...");
    }

    public void stop(){
        double time = System.currentTimeMillis()-millis;
        time /= 1000;
        Bukkit.getConsoleSender().sendMessage("§c§l[§3TntRun§c§l] §c§l[§3Logs§c§l] §aEnabling done! It took §2"+time+"§a seconds.");
    }
